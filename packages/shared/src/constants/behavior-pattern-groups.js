...
exports.PATTERN_TO_GROUP = exports.BEHAVIOR_GROUP_PRIORITY = exports.BEHAVIOR_GROUP_DEFINITIONS = void 0;
exports.BEHAVIOR_GROUP_DEFINITIONS = {
    /**
 ...
 */
exports.BEHAVIOR_GROUP_PRIORITY = [
    "EXIT_RISK",
    "HESITATION",
    "HIGH_INTENT",
    "COMPARISON",
 ...
 */
exports.PATTERN_TO_GROUP = new Map(Object.entries(exports.BEHAVIOR_GROUP_DEFINITIONS)
    .flatMap(([group, def]) => def.patternIds.map((id) => [id, group])));
//# sourceMappingURL=behavior-pattern-groups.js.map