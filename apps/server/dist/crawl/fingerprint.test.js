...
const upsertMock = SiteSelectorFingerprintRepo.upsertFingerprint;
beforeEach(() => {
...
describe("captureFingerprint — hash determinism", () => {
    ...
    it("changes hash when DOM structure changes", () => {
        const a = captureFingerprint(`<html><body class="template-product"><h1>Product</h1></body></html>`, "pdp");
        const b = captureFingerprint(`<html><body class="template-product"><h1>Product</h1><div class="new-section">X</div></body></html>`, "pdp");
