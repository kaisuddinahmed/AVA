...
import { extractStructuredData, extractJsonLd, extractMicrodata, extractOpenGraph, jsonLdTypes, } from "./structured-data.extractor.js";
...
describe("extractMicrodata", () => {
    ...
    `;
        ...
        expect(offers.properties.price).toBe("42.00");
    });
...
//# sourceMappingURL=structured-data.test.js.map