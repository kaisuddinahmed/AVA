...
export const WooCommerceQuickOnboardSchema = z.object({
    ...
    maxProducts: z.number().int().min(1).max(5000).optional(),
}).refine((v) => (v.consumerKey == null && v.consumerSecret == null) ||
    (v.consumerKey != null && v.consumerSecret != null), { message: "consumerKey and consumerSecret must both be provided or both omitted" });
