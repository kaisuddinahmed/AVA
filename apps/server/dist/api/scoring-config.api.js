...
import { ScoringConfigCreateSchema, ScoringConfigUpdateSchema, } from "../validation/schemas.js";
import { logger } from "../logger.js";
const log = logger.child({ service: "api" });
export async function listConfigs(_req, res) {
    try {
...
export async function updateConfig(req, res) {
    try {
        ...
        const config = await ScoringConfigRepo.updateScoringConfig(String(req.params.id), {
            ...updateRest,
...
export async function activateConfig(req, res) {
    try {
...
//# sourceMappingURL=scoring-config.api.js.map