 ...
 */
export declare function install(req: Request, res: Response): void | Response<any, Record<string, any>>;
/**
 * GET /api/shopify/callback?code=...&shop=...&hmac=...
 * OAuth callback: exchange code, inject ScriptTag, register webhooks.
 */
export declare function callback(req: Request, res: Response): Promise<void | Response<any, Record<string, any>>>;
/**
 ...
 */
export declare function webhookUninstall(req: Request, res: Response): Promise<Response<any, Record<string, any>>>;
/**
 ...
 */
export declare function webhookCustomersDataRequest(req: Request, res: Response): Response<any, Record<string, any>>;
/**
 ...
 */
export declare function webhookCustomersRedact(req: Request, res: Response): Response<any, Record<string, any>>;
/**
 * POST /api/shopify/webhooks/gdpr/shop/redact
 * GDPR: erase all shop data. Delete the SiteConfig and all associated data.
 */
export declare function webhookShopRedact(req: Request, res: Response): Promise<Response<any, Record<string, any>>>;
