...
import { promoteSelectorBaseline, getSelectorDriftStatus, triggerSelectorDriftCheck, } from "./drift.api.js";
const markAsBaselineMock = SiteSelectorFingerprintRepo.markAsBaseline;
...
const asReq = (body, query = {}) => ({ body, query, params: {} });
const asRes = (m) => m;
beforeEach(() => {
...
//# sourceMappingURL=drift-selector.test.js.map