...
import { ingestGenericCatalog, } from "../crawl/catalog-ingest.service.js";
...
async function fetchAndDetect(shopUrl) {
 ...
 */
export async function quickOnboard(req, res) {
    ...
    try {
        ...
        res.status(502).json({ error: "Could not reach the shop URL", detail: err.message });
        return;
    }
    // --- Shopify dispatch ----------------------------------------------------
...
// ---------------------------------------------------------------------------
async function runGenericPath(_req, res, shopUrl, detection, maxProducts) {
...
//# sourceMappingURL=onboarding-quick.api.js.map