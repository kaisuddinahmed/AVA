...
export class WidgetShell {
  ...
  // NOTE: AgentController (Story 12 / Phase 2) is wired from ava.ts,
  // not from the shell — it needs wsTransport, panel, and VoiceManager
  // which live at the widget root scope. Do not instantiate it here.
}
